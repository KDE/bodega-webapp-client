...
var communicate = function(req, res, remoteRes, chunk) {
    ...
    if (reply.error) {
        ...
        res.redirect('/account/paymentMethod/create/confirm');
    } else {
        app.operationStatus = true;
        app.operationMessage = 'You new payment method has been added successfuly';
        res.redirect('/account/paymentMethod/create/confirm');
    }
};
