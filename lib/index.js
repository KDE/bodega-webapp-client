    ...
    function parseRootChannels(isHomeIndex) {
        ...
        function parseAssets(assets) {
            ...
            for (assetIt in r.assets) {
                asset = {
                    id: r.assets[assetIt].id,
                    name: r.assets[assetIt].name,
                    version: r.assets[assetIt].version,
                    license: r.assets[assetIt].license,
                    image: r.assets[assetIt].image
                };
        ...
        for (it in rootChannels) {
            makeRequest(options('channel/' + rootChannels[it].id, {}, true), function(r) {
                ...
                console.log(rootChannels[it].subcategories)
