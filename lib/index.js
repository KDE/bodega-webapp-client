        ...
        function(callback) {
            ...
            app.BodegaManager.connect(options('collections/list', null, true), function(remoteRes, chunk) {
                ...
                function next() {
                    ...
                    app.BodegaManager.connect(options('collections/listAssets', { collectionId: temp.id }, true), function(remRes, data) {
...
sockjs_echo.on('connection', function(conn) {
    conn.on('data', function(data) {
        ...
        if (isCollection) {
            app.BodegaManager.connect(options('collections/listAssets', collectionQuery, true), function(remRes, data) {
                var jsonData = JSON.parse(data.toString('utf8'), 'utf8');
            ...
            app.BodegaManager.connect(options('channel/' + categoryId, channelQuery, true), function(remRes, data) {
                var jsonData = JSON.parse(jsonData.toString('utf8'), 'utf8');
